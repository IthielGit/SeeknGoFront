        ...
        <>
          ...
          <div>
            <h1 className="app__header-h1">
              Le moyen le plus simple de trouver une activité de loisir à faire à coté de chez vous
              </h1>
          </div>
          <div className='header__p-Section'>
            <p className="header__p">Tous avec SeeknGo !<br></br> Vous cherchez une activité à faire et vous manquez d'inspiration ? <br></br> SeeknGo vous propose un large choix d'activités et de loisirs à faire  toute l'année dans tout Madagascar. <br></br> Que ce soit en famille,  entre amis, pour une Team Building ou en solo, vous trouverez forcément la formule qui vous conviendra le mieux! Piscine, Yoga, karting,  paintball,  jeux vidéo, ateliers de cuisine, photographie, visites guidées...</p>
          </div>
        </>
      }
